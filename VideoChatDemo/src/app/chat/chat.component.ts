    ...
    this.dataService.messages$.subscribe(
        message => {
            if (message instanceof Blob) {
                // Handle binary data (e.g., Blob objects)
                console.log('Received binary data');
                // Handle the binary data as needed, for example, display the remote video
            } else {
                // Handle JSON data
                console.log('Received JSON data: ' + JSON.stringify(message));
